        ...
        >
          <div className="bg-white/80 backdrop-blur-2xl rounded-[3rem] p-10 lg:p-12 shadow-[0_32px_100px_rgba(0,0,0,0.06)] border border-white relative overflow-hidden">
            ...
            <div className="mb-10 text-center lg:text-left">
              <h2 className="text-3xl font-serif font-black text-slate-800 mb-3">Welcome Back</h2>
              <p className="text-slate-500 font-medium tracking-tight">Log in to your professional legal workspace.</p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="relative py-4 text-center">
                ...
                <span className="relative z-10 bg-white px-4 text-[10px] uppercase font-black tracking-widest text-slate-300">Or continue with</span>
              </div>

              <button 
                type="button"
                onClick={handleGoogleLogin}
                className="w-full bg-white border-2 border-slate-100 text-slate-600 py-4 rounded-2xl font-bold text-sm hover:bg-slate-50 hover:border-slate-200 transition-all flex items-center justify-center gap-3 group"
              >
            ...
            <div className="mt-8 text-center font-bold text-sm text-slate-400">
              ...
              <Link to="/signup" className="text-[#0a0f1e] hover:text-[#C9A84C] transition-colors underline underline-offset-4 decoration-2 decoration-slate-100">Sign Up Free</Link>
            </div>
